...
function header(page) {
  // Home already lists every section in the body, so skip the header nav there.
  const links = page.isHome
    ? ""
    : NAV.map(
        (n) =>
  ...
  <div class="wrap">
    <a class="site-title" href="/" aria-label="Home" title="Home"><img src="/static/icon.png" alt="Home" width="30" height="30"></a>
...
<link href="https://fonts.googleapis.com/css2?family=Archivo:wght@400;500;600;700&family=Merriweather:wght@400;700&family=Space+Mono&display=swap" rel="stylesheet">
