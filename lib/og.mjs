...
async function loadFonts(root) {
  ...
  const [merri, archivo] = await Promise.all([
    readFile(`${root}/assets/fonts/Merriweather-Bold.ttf`),
    readFile(`${root}/assets/fonts/Archivo-Regular.ttf`),
  ])
  fonts = [
    { name: "Merriweather", data: merri, weight: 700, style: "normal" },
      ...
      children: [
        {
          type: "div",
          props: {
            style: { display: "flex", fontSize: 28, color: ACCENT, fontFamily: "Archivo", letterSpacing: "0.05em" },
            children: "blog-19182",
          },
        },
        {
        ...
        },
        {
          type: "div",
          props: {
            style: { display: "flex", fontSize: 30, color: MUTED, fontFamily: "Archivo" },
